...
export default function Hero() {
  return (
    <section
      id="hero"
      className="py-12 md:py-16 bg-gradient-to-b from-background to-background/80 relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 flex flex-col-reverse md:flex-row items-center gap-12 md:gap-20 relative">
        ...
        <div className="flex-1 space-y-8">
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-2xl leading-relaxed">
            ...
            AI Lawyer chatbot. Get instant answers to your legal questions,
            24/7.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 pt-6">
            <Button
              size="lg"
              className="bg-[#BB8A28] hover:bg-[#BB8A28]/90 transition-all duration-300"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-[#BB8A28] text-[#BB8A28] hover:bg-[#BB8A28]/10 hover:text-[#BB8A28] transition-all duration-300"
            >
        ...
        <div className="flex-1 flex justify-center items-center relative">
          <div className="relative w-full max-w-2xl h-auto group">
            ...
            <img
              ...
              onError={(e) => {
                e.currentTarget.src =
                  "https://placehold.co/800x600/BB8A28/FFF?text=AI+Legal+Assistant";
              }}
            />
          </div>
        </div>
