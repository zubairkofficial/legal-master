...
export function AddQuestionForm({ onSuccess, onCancel }: AddQuestionFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Helpers.showToast('Question created successfully', 'success');
      onSuccess();
    } catch (err: any) {
  ...
  return (
    <div className="space-y-4">
      <SheetHeader>
        <SheetTitle className="text-xl">Add New Question</SheetTitle>
        <SheetDescription>
          Create a new question with the following information.
        </SheetDescription>
      </SheetHeader>
